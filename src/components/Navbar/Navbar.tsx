  ...
  return (
    <nav className="fixed top-0 left-0 right-0 h-14 bg-black flex items-center justify-between px-4 z-50 border-b border-neutral-800">
      <div className="flex items-center gap-3">
        <button
          onClick={onMenuClick}
          className="p-2 hover:bg-neutral-800 rounded-full md:hidden"
        >
      ...
      <div className="flex items-center w-1/2 sm:w-2/5">
        <input
          ...
          className="flex-1 h-9 bg-neutral-900 border border-neutral-700 rounded-l-full px-4 text-sm text-white outline-none focus:border-blue-500 min-w-0"
        />
        {inputValue && (
          <button
            onClick={handleClear}
